...
import nativePriceScript from "../../../../extensions/smart-bundle-theme/assets/smart-bundle-native-price.js?raw";
...
export const PREVIEW_SCRIPTS = [
  coreScript, pricingScript, nativePriceScript, formGuardScript, bundleScript,
];
